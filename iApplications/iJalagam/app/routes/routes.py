...
def home():
    ...
    district = payload['district']
    block = payload['block']
    demand, demand_chart_data, demand_side = WaterBudget.get_total_demand(block['id'], district['id'])  
    supply, supply_chart_data, supply_side = WaterBudget.get_total_supply(block['id'], district['id']) 

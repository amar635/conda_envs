...
def livestocks():
    return render_template("mobile/demand/livestocks.html",breadcrumbs=get_breadcrumbs(), menu=get_demand_menu())

@blp.route("/crops")
def crops():
    return render_template("mobile/demand/crops.html",breadcrumbs=get_breadcrumbs(), menu=get_demand_menu())

@blp.route("/industry")
def industry():
    return render_template("mobile/demand/industry.html",breadcrumbs=get_breadcrumbs(), menu=get_demand_menu())

@blp.route("/surface")
def surface():
    return render_template("mobile/supply/surface.html",breadcrumbs=get_breadcrumbs(), menu=get_supply_menu())

@blp.route("/ground")
def ground():
    return render_template("mobile/supply/ground.html",breadcrumbs=get_breadcrumbs(), menu=get_supply_menu())

@blp.route("/rainfall")
def rainfall():
    return render_template("mobile/supply/rainfall.html",breadcrumbs=get_breadcrumbs(), menu=get_supply_menu())

@blp.route("/runoff")
def runoff():
    return render_template("mobile/supply/runoff.html",breadcrumbs=get_breadcrumbs(), menu=get_supply_menu())

...
from finapp.db_extensions import *
from finapp.models.project import projectDataModel, pywfModel
from finapp.models.financial import  FinancialDataModel
from finapp.schemas import FinancialDataSchema
...
def view_finance():
    ...
    return render_template('view_finance.html',project_cost=project_cost,projects=projects,months=months,years=years)

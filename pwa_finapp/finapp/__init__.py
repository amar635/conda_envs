...
from finapp.routes.dashboard import blp as DashboardBlueprint
from finapp.routes.admin import blp as AdminBlueprint
from finapp.routes.controllers import blp as controllers
from finapp.models.admin_model import AdminModel
...
def create_app(db_url=None):
    ...
    api.register_blueprint(controllers)
